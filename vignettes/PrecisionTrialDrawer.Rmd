...
```{r chunk3, echo=TRUE , eval=FALSE, message=TRUE, warning=FALSE, timeit=NULL}
...
```{r chunk6,echo=TRUE,eval=FALSE,message=FALSE,warning=FALSE,timeit=NULL}
...
```{r plot1, echo=TRUE, eval=TRUE, fig.width=7, fig.height=5 , timeit=NULL}
...
```{r plot2 , echo=TRUE , eval=TRUE, fig.width=7, fig.height=7 , timeit=NULL}
...
```{r plotStack,echo=TRUE,eval=TRUE,fig.width=7,fig.height=14,timeit=NULL}
...
```{r plotStackHTMLshow,echo=FALSE,eval=TRUE,results='asis',fig.width=7,fig.height=14,timeit=NULL}
...
```{r plotStack_exclude,echo=TRUE,eval=TRUE,fig.width=7,fig.height=14,timeit=NULL}
...
```{r plot3 , echo=TRUE , eval=TRUE, fig.width=7, fig.height=7, timeit=NULL}
...
```{r chunk9 , echo=TRUE , eval=TRUE, fig.width=7, fig.height=10, timeit=NULL}
...
```{r plot4 , echo=TRUE , eval=TRUE,  fig.width=7, fig.height=7, timeit=NULL}
...
```{r plot5 , echo=TRUE , eval=TRUE , fig.width=7, fig.height=11, timeit=NULL}
...
```{r plot6 , echo=TRUE , eval=TRUE , fig.width=10, fig.height=4, timeit=NULL}
...
```{r plot7 , echo=TRUE , eval=TRUE , fig.height=10, fig.width=15, timeit=NULL}
...
```{r plotDendro,echo=TRUE,eval=TRUE,fig.height=10,fig.width=15, timeit=NULL}
...
So with 
`r sampSize[sampSize$HazardRatio==0.5 & sampSize$Power==0.8,"ScreeningSampleSize"]` 
...
based on the assumption that each arm is completely independent from the others. 
...
```{r basket1 , echo=TRUE , eval=TRUE , fig.width=7, fig.height=7, timeit=NULL}
coverageStackPlot(mypanel , var="drug" 
...
```{r basket2 , echo=TRUE , eval=TRUE , fig.width=7, fig.height=7, timeit=NULL}
coverageStackPlot(mypanel , var="drug" 
        , grouping=NA , collapseByGene=TRUE 
